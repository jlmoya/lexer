...
public class App {
     ...
     *
     */
    private static void processFile(BufferedReader reader, BufferedWriter writer)
        throws IOException {
        ...
        while (line != null) {
            ...
            if (result != null) {
                resultValue =
                    (result % 1) == 0 ? String.valueOf(result.intValue()) : String.valueOf(result);
            }
    ...
    /**
     * @return true if the current thread is running a JUnit test
     */
